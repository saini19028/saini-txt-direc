...
async def info(bot: Client, update: Message):
    ...
    text = (
        ...
        f'╰────────<a href="https://t.me/saini_sahab19" >𝙎𝘼𝙄𝙉𝙄 𝙎𝘼𝙃𝘼𝘽</a>────────╯'
    )
